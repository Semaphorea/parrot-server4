...
class ServiceControllerTest extends WebTestCase
{
    ...
    private string $path = '/crud/service/';
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'service[services]' => 'Testing',
            'service[date_creation]' => 'Testing',
            'service[date_modification]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $fixture->setDate_modification('Value');
        ...
        $this->client->submitForm('Update', [
            'service[services]' => 'Something New',
            'service[date_creation]' => 'Something New',
            'service[date_modification]' => 'Something New',
        ]);

        self::assertResponseRedirects('/crud/service/');
